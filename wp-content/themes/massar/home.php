        ...
        <div class="container">
            ...
            <div class="solution__layout">
                ...
                <form class="solution__form" action="#" method="post">
                    ...
                    <?php echo do_shortcode('[contact-form-7 id="b200192" title="Контактная форма 1"]') ?>

                    <!-- <input id="solution__form-input" class="solution__form-input input-default"
                        name="solution__form-input" type="tel" placeholder="+7 (999) 999-99-99">
                    <button data-modal="modal-order" class="solution__form-button button-default">Получить<br
        ...
        <div class="container">
            ...
            <div class="about__layout">
                <div class="about__text-block">
                    ...
                    <p class="about__text">Пневмопочта - технологичная капсульная система транспортировки предметов,
                        сыпучих субстанций, жидкостей, документов. Транспортная среда пневмоконвейера - трубопроводные
                        каналы, расположенные внутри здания или между разными зданиями. Каждый комплекс оборудования
                        пневматической почты является уникальным и создается по техническому заданию компании –
                        заказчика.</p>
                    <p class="about__text">Компания ООО «ПТС ИНЖИНИРИНГ» (г. Санкт-Петербург), является официальным
                        поставщиком современных систем пневматической почты. Организация работает на российском рынке с
                        2005 года. ООО «ПТС ИНЖИНИРИНГ» выполняет разработку, подбор оборудования и монтаж пневмопочты
                        на предприятиях страны. Компания эксклюзивно представляет высококачественное оборудование и
                        технологии капсульной пневмодоставки.</p>
                    <a href="#" class="about__link">Показать описание полностью</a>
                </div>
                <div class="about__image-block">
                    <picture>
                        <source srcset="<?php bloginfo('template_url'); ?>/assets/img/@2x/about-image--320@2x.jpg"
                            media="(max-width: 320px)">
                        <source srcset="<?php bloginfo('template_url'); ?>/assets/img/@2x/about-image--480@2x.jpg"
                            media="(max-width: 480px)">
                        <source srcset="<?php bloginfo('template_url'); ?>/assets/img/@2x/about-image--640@2x.jpg"
                            media="(max-width: 640px)">
                        <source srcset="<?php bloginfo('template_url'); ?>/assets/img/@2x/about-image--960@2x.jpg"
                            media="(max-width: 960px)">
                        <img class="about__image img-responsive img-responsive--width-100"
                            src="<?php bloginfo('template_url'); ?>/assets/img/@2x/about-image--1366@2x.jpg"
                        ...
                        <div class="contacts__social-block">
                            ...
                            <a href="#" class="contacts__social-whatsapp">
                                <img class="contacts__social-whatsapp-icon"
                                    src="<?php bloginfo('template_url'); ?>/assets/img/svg/contacts-whatsapp-icon.svg"
                                    alt="Иконка whatsapp">
                            </a>
                            <a href="#" class="contacts__social-telegram">
                                <img class="contacts__social-telegram-icon"
                                    src="<?php bloginfo('template_url'); ?>/assets/img/svg/contacts-telegram-icon.svg"
                                    alt="Иконка telegram">
                            </a>
                        </div>
